...
// 无音质回落：无损请求拿不到 FLAC 一律抛 __noLossless 由调用方跳过，绝不落有损充数。
async function downloadSong({ songmid, name, singer, source = 'kw', pic = null, format = 'mp3', lrcText = null, info = null, signal = null, storage = 'mp3' }) {
